  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-800 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-20 left-10 w-72 h-72 bg-white rounded-full mix-blend-multiply filter blur-xl animate-bounce"></div>
        <div className="absolute top-40 right-10 w-72 h-72 bg-yellow-300 rounded-full mix-blend-multiply filter blur-xl animate-bounce"></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-pink-300 rounded-full mix-blend-multiply filter blur-xl animate-bounce"></div>
      </div>
      ...
      <div className="relative z-10 px-4 pb-8 pt-8">
        ...
        {step === "initial" && (
          <div className="max-w-md mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              <Badge variant="glass" className="text-white bg-white/20">
        ...
        {step === "rating" && (
          <div className="max-w-md mx-auto">
            <Card variant="premium" className="text-center mb-8">
              <CardHeader>
